...
class Get_motor_reading(QThread):
    ...
    def run(self):
        ...
        while True:
            ...
            elif 'txm_zp_pix' in self.motor.motor_name or 'display_txm_pix' in self.motor.motor_name:
...
class display_pix_size():
    def __init__(self, obj):
        self.obj = obj
        self.motor_name = 'display_txm_pix'
        self.font1 = QtGui.QFont('Arial', 12, QtGui.QFont.Bold)
        self.font2 = QtGui.QFont('Arial', 12, QtGui.QFont.Normal)
...
class App(QWidget):
    ...
    def layout_matrix_scan_argument(self):
        ...
        self.display_txm_pix = display_pix_size(self)
        ...
        hbox['note'].addWidget(widget_display_pix)
